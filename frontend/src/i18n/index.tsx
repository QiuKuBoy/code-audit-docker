...
const zh: Dict = {
  ...
  'projects.pathPlaceholder': '/path/to/project 或 E:\\my-project',
  'projects.desc': '描述（可选）',
  ...
  // Project source tabs
  'projects.sourceLocal': '本地路径',
  'projects.sourceUpload': '上传压缩包',
  'projects.sourceGit': '在线仓库',
  'projects.zipFile': 'ZIP 压缩包',
  'projects.zipSelect': '点击选择 .zip 文件',
  'projects.zipHint': '上传后自动解压并可直接启动审计，Mac / Docker 部署推荐此方式',
  'projects.gitUrl': '仓库地址',
  'projects.gitUrlPlaceholder': 'https://github.com/user/repo.git',
  'projects.gitHint': '浅克隆（--depth 1）远程仓库到服务器后直接审计',
  'projects.nameOptional': '项目名称（留空自动命名）',
  'projects.pathHint': '仅当后端运行在本机时可用；Docker 部署或 Mac 请用「上传压缩包」或「在线仓库」',
  'projects.autoStart': '创建后立即启动审计',
  'projects.auditMode': '审计模式',
  'projects.provider': 'LLM 提供商',
  'projects.uploading': '上传中...',
  'projects.cloning': '克隆中...（大仓库可能需要几分钟）',
  'projects.startingAudit': '启动审计中...',
...
const en: Dict = {
  ...
  // Project source tabs
  'projects.sourceLocal': 'Local Path',
  'projects.sourceUpload': 'Upload Zip',
  'projects.sourceGit': 'Git Repo',
  'projects.zipFile': 'ZIP archive',
  'projects.zipSelect': 'Click to choose a .zip file',
  'projects.zipHint': 'Upload, extract and audit directly — recommended for Mac / Docker deployments',
  'projects.gitUrl': 'Repository URL',
  'projects.gitUrlPlaceholder': 'https://github.com/user/repo.git',
  'projects.gitHint': 'Shallow clone (--depth 1) the remote repo to the server, then audit',
  'projects.nameOptional': 'Project name (auto-generated if empty)',
  'projects.pathHint': 'Only works when the backend runs on this machine; use Upload Zip or Git Repo for Docker / Mac',
  'projects.autoStart': 'Start audit immediately after creation',
  'projects.auditMode': 'Audit Mode',
  'projects.provider': 'LLM Provider',
  'projects.uploading': 'Uploading...',
  'projects.cloning': 'Cloning... (large repos may take a few minutes)',
  'projects.startingAudit': 'Starting audit...',
  'projects.path': 'Project path (local)',
  'projects.pathPlaceholder': '/path/to/project',
  'projects.name': 'Project name',
  'projects.desc': 'Description (optional)',
  'projects.descPlaceholder': 'Short description',
  'projects.create': 'Create',
  'projects.cancel': 'Cancel',
  'projects.delete': 'Delete this project?',
  'projects.language': 'Language',
  'projects.languageAuto': 'Auto-detect',
  'projects.languageHint': 'Picking a language skips auto-detection and ensures matching skill packs',
}
