...
const en: Dict = {
  ...
  'nav.hideCompleted': 'Hide completed projects when creating',
  'nav.mcp': 'MCP Services',
  'nav.newProject': 'New Project',
  'nav.noProjects': 'No projects',
  'nav.projectStatus.completed': 'Completed',
  'nav.projectStatus.inProgress': 'In Progress',
  'nav.projectStatus.unaudited': 'Unaudited',
  'nav.projects': 'Projects',
  'nav.projectsCollapse': 'Collapse Projects',
  'nav.projectsExpand': 'Expand Projects',
  'nav.runtime': 'Local Runtime',
  'nav.skills': 'Skill Packs',
  ...
  'projects.empty': 'No projects yet. Create one to start auditing.',
  ...
  'projects.languageHint': 'Selecting a language skips auto-detection and ensures matching skill packs',
  'projects.languagePlaceholder': 'Select project language',
  'projects.loading': 'Loading...',
  'projects.name': 'Project name',
  'projects.nameOptional': 'Project name (auto-generated if empty)',
  'projects.new': 'New Project',
  'projects.noArchived': 'No archived projects',
  'projects.noCompleted': 'No completed audits',
  'projects.noInProgress': 'No audits in progress',
  ...
  'projects.pathPlaceholder': '/path/to/project or E:\\my-project',
  ...
  'projects.subtitle': 'Manage code projects pending audit',
  ...
  // Audit
  'audit.abort': 'Abort',
  'audit.abortConfirm': 'Abort this audit?',
  'audit.aborting': 'Aborting...',
  'audit.auditing': 'Auditing... no findings yet',
  'audit.back': 'Back',
  'audit.codeSnippet': 'Code Snippet',
  'audit.common': 'Common',
  'audit.compare': 'Compare',
  'audit.compareTitle': 'Audit Comparison',
  'audit.confirmed': 'Confirmed',
  'audit.coverage': 'Coverage',
  'audit.delete': 'Delete',
  'audit.deleteConfirm': 'Delete this audit and all its findings and logs? This cannot be undone.',
  'audit.deleteRunning': 'Audit is running, please abort before deleting',
  'audit.deleted': 'Deleted {n} audit(s) ({f} findings, {l} logs)',
  'audit.description': 'Description',
  'audit.exploitChain': 'Exploit Chain',
  'audit.exportHtml': 'Export HTML',
  'audit.exportMd': 'Export Markdown',
  'audit.exportReport': 'Export Report',
  'audit.exportSarif': 'Export SARIF',
  'audit.findings': 'Findings',
  'audit.findingsTab': 'Findings',
  'audit.fix': 'Remediation',
  'audit.items': 'items',
  'audit.logs': 'Logs',
  'audit.logsTab': 'Logs',
  'audit.mcpConnected': 'Connected',
  'audit.mcpDisconnected': 'Disconnected',
  'audit.mcpStatus': 'MCP Status',
  'audit.mode.comprehensive': 'Comprehensive',
  'audit.mode.quick': 'Quick Scan',
  'audit.mode.smart': 'Smart Audit',
  'audit.next': 'Next',
  'audit.noFindings': 'No vulnerabilities found',
  'audit.noFindingsYet': 'Audit in progress, no findings yet...',
  'audit.noLogs': 'No logs yet',
  'audit.of': 'of',
  'audit.onlyInA': 'Only in Audit A',
  'audit.onlyInB': 'Only in Audit B',
  'audit.orchestration': 'Agent Orchestration',
  'audit.overview': 'Overview',
  'audit.pageSize': 'per page',
  'audit.pending': 'Pending',
  'audit.pipeline': 'Audit Pipeline',
  'audit.poc': 'PoC Verification',
  ...
  'audit.reportTitle': 'Code Security Audit Report',
  'audit.reportZh': 'Chinese Report',
  'audit.resume': 'Resume',
  'audit.resuming': 'Resuming...',
  'audit.selectCompare': 'Select two audits to compare',
  ...
  'audit.status.max_turns': 'Max turns reached',
  ...
  'dashboard.statusDist': 'Audit Status Distribution',
  'dashboard.subtitle': 'Audit overview & statistics',
  'dashboard.timeline': 'Finding Trend',
  ...
  'dashboard.typeDist': 'Vulnerability Type Distribution',
  ...
  // Skills
  'skills.builtinProtected': 'Built-in skills cannot be deleted',
  'skills.content': 'Skill Content (Markdown)',
  'skills.contentPlaceholder': '# Skill Title\n\n## Audit Method\n...',
  ...
  'skills.namePlaceholder': 'e.g. jwt_audit',
  'skills.new': 'New Skill',
  'skills.newTitle': 'New Custom Skill Pack',
  'skills.search': 'Search skills...',
  'skills.sortedByEfficiency': 'Sorted by efficiency',
  'skills.subtitle': 'Audit skill packs sorted by vulnerability-finding efficiency; S-tier is the highest value',
  'skills.tierA': 'A-tier · High value',
  'skills.tierB': 'B-tier · Medium value',
  'skills.tierC': 'C-tier · Auxiliary',
  'skills.tierS': 'S-tier · Highest value',
  ...
  'mcp.authEnabled': 'Auth configured',
  'mcp.calls': 'Calls',
  'mcp.configProtected': 'Built-in servers in config.py cannot be deleted (only runtime-added ones)',
  ...
  'mcp.descriptionPlaceholder': 'Server description (optional)',
  ...
  'mcp.namePlaceholder': 'e.g. src-wiki',
  'mcp.noAuth': 'No auth',
  'mcp.subtitle': 'External knowledge connectors, providing CVE / vulnerability pattern queries for audit agents',
  'mcp.test': 'Test Connection',
  'mcp.testing': 'Testing...',
  'mcp.toolList': 'Tool List',
  'mcp.tools': 'Tools',
  'mcp.url': 'Server URL',
  'mcp.urlPlaceholder': 'https://example.com/mcp',
